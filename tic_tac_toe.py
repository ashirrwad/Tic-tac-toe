...
###############   Main Program #################
root=Tk()                   #Initializing object / making a window
root.title("Tic-Tac-Toe")   #Title for the window
a=r.choice(['O','X'])       #Choices defined
